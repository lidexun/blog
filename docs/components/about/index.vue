...
.project_app_title {
  ...
  -webkit-text-stroke-color: rgba(139, 92, 246, 1);
  margin-bottom: 1rem;
}
...
/* .project_other_bg {
  ...
  margin: 0;
  margin: 0 auto;
  background: url(/blog/other_bg.jpg) center/cover;
